...
if ( ! class_exists( 'BuilderPress_VC_Font' ) ) {
	/**
	 * Class BuilderPress_VC_Font
	 */
	class BuilderPress_VC_Font {

		/**
		 * BuilderPress_VC_Font constructor.
		 */
		public function __construct() {
			// register font
			add_action( 'vc_base_register_front_css', array( $this, 'register_font_icons' ) );
			add_action( 'vc_base_register_admin_css', array( $this, 'register_font_icons' ) );

			// add iconpicker editor
			add_action( 'vc_backend_editor_enqueue_js_css', array( $this, 'add_iconpicker_editor' ) );
			add_action( 'vc_frontend_editor_enqueue_js_css', array( $this, 'add_iconpicker_editor' ) );

			// font icon
			add_action( 'vc_enqueue_font_icon_element', array( $this, 'enqueue_font_icon' ) );

			// add iconicons
			add_filter( 'vc_iconpicker-type-ionicon', array( $this, 'add_ionicons' ) );
		}

		/**
		 * Register font icons.
		 */
		public function register_font_icons() {
			wp_register_style( 'builder-press-ionicons', BUILDER_PRESS_URL . '/assets/css/fonts/ionicons.css' );
		}

		/**
		 * Add icon types in editor.
		 */
		public function add_iconpicker_editor() {
		 ...
		 * @param $font
		 */
		public function enqueue_font_icon( $font ) {
			switch ( $font ) {
				case 'ionicons':
					wp_enqueue_style( 'builder-press-ionicons' );
			}
		...
		public function add_ionicons( $icons ) {
			$ionicons = apply_filters( 'builder-press/ionicons', array(
