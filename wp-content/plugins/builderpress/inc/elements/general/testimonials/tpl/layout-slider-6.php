<?php
/**
 * Template for displaying template Testimonials element layout slider 6.
 *
 * This template can be overridden by copying it to yourtheme/builderpress/testimonials/layout-slider-6.php.
 *
 * @author      ThimPress
                    ...
                    <div class="info-wrap">
                        ...
                        <?php if ( isset( $testimonial['image'] ) ) { ?>
                            <div class="image">
                                ...
                                $size         = apply_filters( 'builder-press/testimonial/image-size', '48x48' );
