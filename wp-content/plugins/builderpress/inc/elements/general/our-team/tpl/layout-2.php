<?php
/**
 * Template for displaying template Our team element layout 2.
 *
 * This template can be overridden by copying it to yourtheme/builderpress/our-team/layout-2.php.
 *
 * @author      ThimPress
...
$size = apply_filters( 'builder-press/our-team/layout-2/image-size', '250x330' );
?>
            ...
            <div class="item-inner">
                ...
                <?php if ( $avatar_id ) { ?>
                    <div class="avatar-contact">
                        <div class="avatar">
                            <?php
                                builder_press_get_attachment_image($avatar_id, 'full');
                            ?>
                        </div>
                        <!--                        contact-->
