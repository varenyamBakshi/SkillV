...
if ( ! class_exists( 'Thim_Plugin' ) ) {
	class Thim_Plugin {
		...
		public function __construct( $slug = '', $is_wporg = false ) {
			...
			$this->messages = array( esc_attr__( 'Something went wrong!', 'ivy-school' ) );
		...
		public function get_text_status() {
			$arrText = array(
				'active'        => esc_attr__( 'Active', 'ivy-school' ),
				'inactive'      => esc_attr__( 'Inactive', 'ivy-school' ),
				'not_installed' => esc_attr__( 'Not Installed', 'ivy-school' )
			);
