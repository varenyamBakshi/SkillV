...
thim_customizer()->add_field(
    array(
        'id'       => 'event_single_hide_page_title',
        'type'     => 'switch',
...
thim_customizer()->add_field(
    array(
        'id'       => 'event_single_hide_breadcrumb',
        'type'        => 'switch',
...
thim_customizer()->add_field(
    array(
        'id'       => 'event_single_heading_background_image',
        'type'     => 'image',
...
thim_customizer()->add_field(
    array(
        'id'        => 'event_single_heading_background_color',
        'type'      => 'color',
...
thim_customizer()->add_field(
    array(
        'id'        => 'event_single_background_opacity',
        'type'      => 'text',
