...
<div class="learn-press-subtab-content">
    ...
    <h3 class="profile-heading"><?php _e( 'Purchased Courses', 'ivy-school' ); ?></h3>
	...
	<?php if ( $query['items'] ) { ?>
        <table class="lp-list-table profile-list-courses profile-list-table">
            <thead>
            <tr>
                <th class="column-course"><?php _e( 'Course', 'ivy-school' ); ?></th>
                <th class="column-date"><?php _e( 'Date', 'ivy-school' ); ?></th>
                <th class="column-passing-grade"><?php _e( 'Passing Grade', 'ivy-school' ); ?></th>
                <th class="column-status"><?php _e( 'Progress', 'ivy-school' ); ?></th>
            </tr>
            </thead>
            <tbody>
	...
	<?php } else {
		learn_press_display_message( __( 'No courses!', 'ivy-school' ) );
	} ?>
</div>
