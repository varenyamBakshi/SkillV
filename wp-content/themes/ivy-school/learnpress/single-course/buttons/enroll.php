...
<?php do_action( 'learn-press/before-enroll-form' ); ?>
    ...
    <form name="enroll-course" class="enroll-course" method="post" enctype="multipart/form-data">
        ...
        <button class="lp-button button-enroll-course btn-normal shape-round">
			<?php echo esc_html( apply_filters( 'learn-press/enroll-course-button-text', esc_html__( 'Enroll', 'ivy-school' ) ) ); ?>
        </button>
