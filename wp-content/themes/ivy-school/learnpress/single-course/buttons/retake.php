...
<?php do_action( 'learn-press/before-retake-form' ); ?>
    ...
    <form name="retake-course" class="retake-course" method="post" enctype="multipart/form-data"
        ...
        <button class="lp-button button button-retake-course btn-normal shape-round btn-primary">
			<?php echo esc_html( sprintf( apply_filters( 'learn-press/retake-course-button-text', __( 'Retake course (+%d)', 'ivy-school' ) ), $count ) ); ?>
        </button>
