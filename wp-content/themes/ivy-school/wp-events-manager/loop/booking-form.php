    ...
    <form name="event_register" class="event_register" method="POST">
		...
		<?php } else { ?>
            <div class="event_auth_form_field">
                <label for="event_register_qty"><?php _e( 'Quantity', 'ivy-school' ) ?></label>
		...
		<?php if ( !$event->is_free() ) {
			...
			<?php } else {
				wpems_print_notice( 'error', esc_html__( 'There are no payment gateway available. Please contact administrator to setup it.', 'ivy-school' ) );
			}
		} ?>
        ...
        <div class="event_register_foot">
            ...
            <button class="event_register_submit event_auth_button btn-normal shape-round btn-primary" <?php echo $payments ? '' : 'disabled="disabled"' ?>><?php _e( 'Register Now', 'ivy-school' ); ?></button>
        </div>
